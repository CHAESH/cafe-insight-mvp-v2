...
-- =============================================
-- PART 2: RLS (Row Level Security) 정책 설정
-- =============================================
...
-- =============================================
-- Calculation_ingredients 테이블 정책
-- =============================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ 카페인사이트 데이터베이스 설정이 완료되었습니다!';
    RAISE NOTICE '- 11개 테이블 생성 완료';
    RAISE NOTICE '- RLS 정책 적용 완료';
    RAISE NOTICE '- 기본 데이터 삽입 완료';
